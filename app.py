...
# & line items with filters applied and dimensions joined
def get_order_details(filter_part_type,filter_brand_name,filter_supplier_name,filter_shipping_date):
    ...
    # Additional column: Return Flag, Order Status and Order Year-Month
    ...
    # Joining the modified fact to the filtered dimensions 
...
# Filters => Part Type - Part Brand Name - Supplier Name
...
measure_name = st.radio('Metric:',['Count of Orders','Total Revenue','Both'],
